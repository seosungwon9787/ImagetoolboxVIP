from scipy import ndimage #using for canny edge detection
from scipy.ndimage.filters import convolve #using for canny edge detection
import math
import cv2
